...
class CreditRating(Base):
    ...
    previous_rating: Mapped[str | None] = (
...
class YieldCurve(Base):
    ...
    yield_pct: Mapped[float] = mapped_column(
...
class Bond(Base):
    ...
    coupon_frequency: Mapped[int | None] = (
    ...
    bond_type: Mapped[str | None] = mapped_column(
        String(30)
    )
    is_callable: Mapped[bool] = mapped_column(
