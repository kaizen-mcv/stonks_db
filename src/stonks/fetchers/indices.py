...
INDICES = [
    ...
    ("DJI", "^DJI", "Dow Jones Industrial", "USA",
     "USD"),
    ...
    ("FTSEMIB", "FTSEMIB.MI",
     "FTSE MIB", "ITA", "EUR"),
    ("SMI", "^SSMI", "Swiss Market Index", "CHE",
     "CHF"),
    ("AEX", "^AEX", "AEX", "NLD", "EUR"),
    ("NIKKEI", "^N225", "Nikkei 225", "JPN", "JPY"),
    ("HSI", "^HSI", "Hang Seng", "HKG", "HKD"),
    ("SSEC", "000001.SS",
     "Shanghai Composite", "CHN", "CNY"),
    ("KOSPI", "^KS11", "KOSPI", "KOR", "KRW"),
    ("ASX200", "^AXJO", "S&P/ASX 200", "AUS",
     "AUD"),
    ("TSX", "^GSPTSE", "S&P/TSX Composite", "CAN",
     "CAD"),
    ("BOVESPA", "^BVSP", "Bovespa", "BRA", "BRL"),
    ("SENSEX", "^BSESN", "BSE SENSEX", "IND",
     "INR"),
    ("STOXX50", "^STOXX50E",
     "Euro Stoxx 50", None, "EUR"),
]
